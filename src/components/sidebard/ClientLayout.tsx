...
export default function ClientLayout({ children, search = true }: Props) {
    ...
    return (
        <Box maxWidth={1200} my={2} width={'100%'} px={2} mx={'auto'}>
            <Box
                display={'flex'}
            ...
            >
                ...
                <Box display={{ md: 'flex', sm: 'none', xs: 'none' }} alignItems={'center'} gap={2}>
                ...
                <Box display={{ md: 'none', sm: 'flex', xs: 'flex' }} alignItems={'center'} gap={2}>
